...
const Form = ({listTransactions, setListTransactions, setEmpty, setFilterTransactions}) =>{
  ...
  return (
    <form className='form'>
      ...
      <button onClick={handleListTransaction} className='buttonForm'>Inserir Valor</button>
    </form>
  )
}
export default Form;